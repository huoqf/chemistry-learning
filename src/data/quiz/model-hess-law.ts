  ...
  variantQuizzes: [
    {
      ...
      modelAlignmentAnalysis: '【母题模型对齐】：目标反应为 CO₂(g) + C(s) = 2CO(g)。由方程式 ③ * 2 - ② 可得：2C(s) + 2H₂O(g) - [CO₂(g) + 2H₂(g) - C(s) - 2H₂O(g)] = 2CO(g) + 2H₂(g)，即 CO₂(g) + C(s) = 2CO(g)。ΔH = 2 * (+131.3) - (-90.1) = +352.7? 不，重新叠加：方程式 ③ 乘以 2 减去 ② 得 ΔH = 2 * 131.3 - (-90.1) = +352.7。',
    ...
    {
      id: 'var-hess-2',
      yearProvince: '2023 全国外刊/高考模拟卷',
      modelId: 'model-hess-law',
      title: '高频微观键能与晶体结构键数陷阱计算',
      contextDescription: '已知几种化学键的键能如下表：\nSi-Si: 222 kJ/mol, Si-O: 460 kJ/mol, O=O: 498 kJ/mol, C-H: 414 kJ/mol, C=O: 803 kJ/mol, O-H: 464 kJ/mol。\n晶体硅与二氧化硅均为立体网状晶体。',
      questionText: '计算 1 mol 晶体硅完全燃烧生成 1 mol SiO₂(s) 的反应焓变 ΔH 为多少 kJ/mol？',
      options: [
        { label: 'A', text: '-991 kJ/mol', isCorrect: true },
        { label: 'B', text: '-531 kJ/mol', isCorrect: false },
        { label: 'C', text: '-1342 kJ/mol', isCorrect: false },
        { label: 'D', text: '+991 kJ/mol', isCorrect: false },
      ],
