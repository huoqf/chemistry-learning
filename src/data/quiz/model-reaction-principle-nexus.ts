...
export const modelReactionPrincipleNexus: ModelQuizData = {
  ...
  variantQuizzes: [
    ...
    },
    {
      ...
      questionText: '下列关于 P₁ 与 P₂ 大小关系及曲线走向的说法正确的是（ ）',
      options: [
        { label: 'A', text: 'P₁ < P₂，升高温度平衡正向移动', isCorrect: false },
        { label: 'B', text: 'P₁ > P₂，升高温度 A 的平衡转化率 α 减小', isCorrect: true },
        { label: 'C', text: 'P₁ = P₂，压强改变对平衡无影响', isCorrect: false },
        { label: 'D', text: '该反应为吸热反应', isCorrect: false },
      ],
    ...
    },
    {
      ...
      questionText: '该反应以平衡分压表示的压强平衡常数 Kp 计算表达式为：',
      options: [
        { label: 'A', text: 'Kp = (4α² · P) / (1 - α²)', isCorrect: true },
        { label: 'B', text: 'Kp = (2α · P) / (1 - α)', isCorrect: false },
        { label: 'C', text: 'Kp = α² · P / (1 - α)', isCorrect: false },
        { label: 'D', text: 'Kp = 4α · P / (1 + α)', isCorrect: false },
      ],
