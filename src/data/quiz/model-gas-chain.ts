...
export const modelGasChainQuiz: ModelQuizData = {
  ...
  variantQuizzes: [
    ...
    },
    {
      ...
      modelId: 'model-gas-chain',
      title: 'SO₂ 发生、KMnO₄ 还原性检验与品红漂白检验装置链',
      contextDescription: '利用 Cu 与浓 H₂SO₄ 加热制备 SO₂，气体依次通过酸性 KMnO₄ 溶液、品红溶液及 NaOH 尾气吸收瓶。',
      ...
      options: [
        ...
        { label: 'C', text: 'NaOH 尾气吸收瓶应采用“短进长出”', isCorrect: false },
        { label: 'D', text: '可用无水 CaCl₂ 替代 NaOH 吸收尾气中的 SO₂', isCorrect: false },
      ],
      modelAlignmentAnalysis: '考查 SO₂ 还原性 (使 KMnO₄ 褪色, 5SO₂ + 2MnO₄⁻ + 2H₂O = 5SO₄²⁻ + 2Mn²⁺ + 4H⁺) 与漂白性 (使品红褪色, 加热复原) 的严密区分。',
      detailedExplanation: 'SO₂ 与 KMnO₄ 发生氧化还原反应使高锰酸钾褪色体现还原性；SO₂ 与有色有机物结合生成无色不稳定物质使品红褪色体现漂白性，故 B 项完全正确。',
      diagramType: 'titration-error-diagram',
      diagramConfig: {
        errorDiagramType: 'iodometry-purity',
        title: 'Cu+浓H₂SO₄ ➔ 酸性KMnO₄ (还原性) ➔ 品红 (漂白性) ➔ NaOH 洗气链图',
      },
    },
    {
      id: 'gas-quiz-4',
