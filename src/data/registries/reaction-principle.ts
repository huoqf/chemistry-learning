  ...
  'anim-collision-theory': {
    ...
    paramMeta: [
      {
        ...
        unit: 'K',
        group: '反应环境',
        description: '升高温度显著增大活化分子比例 f 与碰撞频率 Z',
      },
      {
        key: 'concentration',
        label: '反应物浓度 c',
        ...
        unit: 'mol/L',
        group: '反应环境',
        description: '增大浓度增加单位体积内总分子数与碰撞频率，f 不变',
      },
      {
    ...
    controlMeta: [
      ...
      },
      {
        ...
        key: 'reactionType',
        options: [
          { label: '放热 (ΔH < 0)', value: 0 },
          { label: '吸热 (ΔH > 0)', value: 1 },
        ],
      },
      {
        type: 'toggle',
      ...
      },
      {
        ...
        group: '高考考点说明',
        variant: 'primary',
        content: '调节温度、浓度、活化能与催化剂，左侧观察微观粒子定向碰撞与有效碰撞过程，右侧观察反应势能面与麦克斯韦-玻尔兹曼能量分布图联动变化。',
      },
    ],
