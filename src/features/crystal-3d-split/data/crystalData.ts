...
export const CRYSTAL_DATA_MAP: Record<CrystalTypeId, CrystalTypeData> = {
  ...
  'hcp-mg': {
    ...
    atoms: [
      // 顶点 8
      { id: 'mg-c0', element: 'Mg', fracPos: [0, 0, 0], locationType: 'corner', sharingRatio: 1 / 8, sharingLabel: '顶点 (1/8)', color: ATOM_COLORS.Mg, radius: 0.22 },
      { id: 'mg-c1', element: 'Mg', fracPos: [1, 0, 0], locationType: 'corner', sharingRatio: 1 / 8, sharingLabel: '顶点 (1/8)', color: ATOM_COLORS.Mg, radius: 0.22 },
      { id: 'mg-c2', element: 'Mg', fracPos: [0, 1, 0], locationType: 'corner', sharingRatio: 1 / 8, sharingLabel: '顶点 (1/8)', color: ATOM_COLORS.Mg, radius: 0.22 },
      { id: 'mg-c3', element: 'Mg', fracPos: [1, 1, 0], locationType: 'corner', sharingRatio: 1 / 8, sharingLabel: '顶点 (1/8)', color: ATOM_COLORS.Mg, radius: 0.22 },
      { id: 'mg-c4', element: 'Mg', fracPos: [0, 0, 1], locationType: 'corner', sharingRatio: 1 / 8, sharingLabel: '顶点 (1/8)', color: ATOM_COLORS.Mg, radius: 0.22 },
      { id: 'mg-c5', element: 'Mg', fracPos: [1, 0, 1], locationType: 'corner', sharingRatio: 1 / 8, sharingLabel: '顶点 (1/8)', color: ATOM_COLORS.Mg, radius: 0.22 },
      { id: 'mg-c6', element: 'Mg', fracPos: [0, 1, 1], locationType: 'corner', sharingRatio: 1 / 8, sharingLabel: '顶点 (1/8)', color: ATOM_COLORS.Mg, radius: 0.22 },
      { id: 'mg-c7', element: 'Mg', fracPos: [1, 1, 1], locationType: 'corner', sharingRatio: 1 / 8, sharingLabel: '顶点 (1/8)', color: ATOM_COLORS.Mg, radius: 0.22 },
      // 内部 1
