...
export const RETRO_MODELS_DATA: Record<RetrosynthesisModelId, RetrosynthesisModelData> = {
  'aspirin-benorilate': {
    ...
    coreStrategy:
      '逆向切断酯键 (✂ C-O) 得到乙酰水杨酸与对乙酰氨基酚；水杨酸酚羟基需先用乙酸酐选择性酰化保护，避免二次交联。',
    protectionKeyPoints: [
    ...
    steps: [
      {
        ...
        nodes: [
          { id: 'tm', label: '贝诺酯 (TM)', formula: 'C₁₇H₁₅NO₅', x: 420, y: 120, role: 'TM', isTarget: true },
          { id: 'p1', label: '乙酰水杨酸 (前体A)', formula: 'C₉H₈O₄', x: 220, y: 360, role: 'precursor', badge: '亲电 Synthons' },
          { id: 'p2', label: '对乙酰氨基酚 (前体B)', formula: 'C₈H₉NO₂', x: 620, y: 360, role: 'precursor', badge: '亲核 Synthons' },
        ],
        connections: [
  ...
  'diels-alder-acetal': {
    ...
    difficulty: '高考冲刺',
    description:
      '目标分子含有碳碳双键与醛基、醇羟基。在利用 LiAlH₄ 强还原剂将酯还原为醇时，活泼醛基会被优先破坏，需用乙二醇将其转化为环状缩醛进行保护。',
    coreStrategy:
    ...
    steps: [
      {
        ...
        nodes: [
          ...
          { id: 'd2', label: '4-氧代-2-丁烯酸甲酯 (含-CHO 与 -COOMe)', formula: 'C₅H₆O₃', x: 620, y: 110, role: 'precursor', badge: '亲双烯体' },
          { id: 'im', label: '6-甲酰基-3-环己烯羧酸甲酯', formula: 'C₉H₁₂O₃', x: 420, y: 330, role: 'intermediate', isProtectedGroup: false, badge: '含活泼醛基' },
        ],
        connections: [
      ...
      {
        stepIndex: 2,
        title: '第 2 步：醛基的乙二醇环状缩醛 Protection',
        description: '中间体中的醛基用乙二醇选择性保护为环状缩醛，使其能耐受下一步 LiAlH₄ 强还原条件。',
        reactants: [
          { name: '6-甲酰基-3-环己烯羧酸甲酯', formula: 'C₉H₁₂O₃' },
        ...
        protectionStatus: {
          ...
          reason: '缩醛基团对还原剂 LiAlH₄ 和强碱具有高度惰性，避免醛被还原。',
        },
        cutBond: null,
        atomEconomy: 92.2,
        fgiType: '缩醛保护 (Acetal Protection)',
        nodes: [
          { id: 'im', label: '未保护醛中间体', formula: 'C₉H₁₂O₃', x: 220, y: 120, role: 'intermediate' },
          { id: 'eg', label: '乙二醇 Protection 试剂', formula: 'HO-CH₂CH₂-OH', x: 620, y: 120, role: 'reagent' },
          { id: 'act', label: '环状缩醛 (Protection 态)', formula: 'C₁₁H₁₆O₄', x: 420, y: 330, role: 'protected', isProtectedGroup: true, badge: '抗强碱/强还原剂' },
          { id: 'h2o', label: '分水器脱水', formula: 'H₂O', x: 420, y: 510, role: 'intermediate', badge: '促平衡正向' },
        ],
        connections: [
          { from: 'im', to: 'act', label: '醛基缩醛化' },
          { from: 'eg', to: 'act', label: '形成 1,3-二氧五环', isProtectionShield: true },
          { from: 'act', to: 'h2o', label: '脱水' },
        ],
      },
      {
        stepIndex: 3,
        title: '第 3 步：强还原剂还原酯基与稀酸水解脱保护',
        description: 'LiAlH₄ 选择性将酯基还原为 -CH₂OH，随后加入稀盐酸 (H₃O⁺) 加热脱去缩醛保护基，恢复 -CHO。',
        reactants: [
          { name: '缩醛中间体', formula: 'C₁₁H₁₆O₄' },
          { name: 'LiAlH₄ 还原剂与水解酸', formula: '还原剂 + 稀酸' },
        ],
        products: [
          { name: '4-羟甲基-3-环己烯甲醛 (TM)', formula: 'C₈H₁₂O₂' },
          { name: '乙二醇 (脱去)', formula: 'HO(CH₂)₂OH' },
        ],
        reagents: '1. LiAlH₄ / THF  2. 稀盐酸 / Δ 加热',
        protectionStatus: {
          isProtected: false,
        ...
        nodes: [
          { id: 'act', label: '环状缩醛', formula: 'C₁₁H₁₆O₄', x: 220, y: 120, role: 'protected', isProtectedGroup: true },
          { id: 'rg', label: '1. LiAlH₄  2. H₃O⁺ 试剂', formula: '试剂与酸', x: 620, y: 120, role: 'reagent' },
          { id: 'tm', label: '4-羟甲基-3-环己烯甲醛 (TM)', formula: 'C₈H₁₂O₂', x: 420, y: 330, role: 'TM', isTarget: true, badge: '还原+脱保护成功' },
          { id: 'eg_free', label: '复原游离乙二醇', formula: 'HO(CH₂)₂OH', x: 420, y: 510, role: 'intermediate', badge: '保护基回收' },
        ],
        connections: [
          { from: 'act', to: 'tm', label: '还原 -COOMe 为 -CH₂OH' },
          { from: 'rg', to: 'tm', label: 'H₃O⁺ 水解脱去缩醛' },
    ...
    steps: [
      {
        ...
        protectionStatus: {
          ...
          reason: '加成消除双键不饱和性，防止后续强碱性烷基化过程中发生异构化或氧化。',
        },
        cutBond: null,
        atomEconomy: 100.0,
        fgiType: '双键加溴保护 (Protection)',
        nodes: [
          { id: 'ph', label: '4-烯丙基苯酚 (原料)', formula: 'C₉H₁₀O', x: 220, y: 110, role: 'precursor' },
          { id: 'br', label: 'Br₂ Protection 试剂', formula: 'Br₂', x: 620, y: 110, role: 'reagent' },
          { id: 'dib', label: '邻二溴代物 (Protection 态)', formula: 'C₉H₁₀Br₂O', x: 420, y: 330, role: 'protected', isProtectedGroup: true, badge: '双键已饱和化' },
        ],
        connections: [
      ...
      },
      {
        ...
        nodes: [
          { id: 'dib', label: '二溴代酚', formula: 'C₉H₁₀Br₂O', x: 220, y: 110, role: 'intermediate' },
          { id: 'me', label: 'CH₃I 甲基化试剂', formula: 'CH₃I', x: 620, y: 110, role: 'reagent' },
          { id: 'eth', label: '二溴甲基醚中间体', formula: 'C₁₀H₁₂Br₂O', x: 420, y: 330, role: 'intermediate', badge: '酚醚已生成' },
  ...
  'carbon-carbon-builder': {
    ...
    title: '模型四：高考推断 C-C 键构建 (格氏试剂与逆合成切断)',
    ...
    steps: [
      {
        ...
        nodes: [
          ...
          { id: 'b2', label: '苯乙酮 (亲核Synthons)', formula: 'C₈H₈O', x: 620, y: 320, role: 'precursor', badge: '亲核 α-H 前体' },
        ...
        connections: [
          ...
          { from: 'tm', to: 'b2', label: '✂ 释放苯乙酮', isDisconnection: true },
      ...
      },
      {
        ...
        nodes: [
          ...
          { id: 'b2', label: '苯乙酮 (酮基)', formula: 'C₈H₈O', x: 620, y: 120, role: 'precursor' },
