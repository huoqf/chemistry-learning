...
export const GAOKAO_3D_MOLECULES: Record<string, Organic3DMolecule> = {
  ...
  aspirin: {
    ...
    atoms: [
      ...createBenzeneRing([0, 0, 0], 1.35, 'asp-ring', [0, 1]).atoms,
      ...
      ...createMethylGroup([1.5, 3.9, 0], [0.9, 1.1, 0], 'asp-me').atoms,
    ],
    bonds: [
      ...createBenzeneRing([0, 0, 0], 1.35, 'asp-ring', [0, 1]).bonds,
      { id: 'ring-c_cooh', start: [1.35, 0, 0], end: [2.3, 0.3, 0], order: 1 },
      ...
      { id: 'ring-o_pe', start: [1.35 * Math.cos(Math.PI / 3), 1.35 * Math.sin(Math.PI / 3), 0], end: [1.2, 1.8, 0], order: 1 },
      ...
      ...createMethylGroup([1.5, 3.9, 0], [0.9, 1.1, 0], 'asp-me').bonds,
    ],
  },
  ...
  'formic-phenyl-ester': {
    ...
    atoms: [
      ...createBenzeneRing([1.8, 0, 0], 1.35, 'fpe-ring', [3]).atoms,
      { id: 'o_pe', symbol: 'O', elementName: '酚酯氧', position: [-0.7, 0, 0], color: ATOM_COLORS.O, radius: 0.33, isFunctionalGroup: true },
      { id: 'c_formyl', symbol: 'C', elementName: '甲酰基碳 (sp²)', position: [-1.8, 0.5, 0], color: ATOM_COLORS.C, radius: 0.35, isFunctionalGroup: true },
      { id: 'o_formyl', symbol: 'O', elementName: '羰基氧', position: [-1.8, 1.75, 0], color: ATOM_COLORS.O, radius: 0.33, isFunctionalGroup: true },
      { id: 'h_formyl', symbol: 'H', elementName: '甲酸醛基氢 (还原性)', position: [-2.8, -0.1, 0], color: ATOM_COLORS.H, radius: 0.22, isFunctionalGroup: true },
    ],
    bonds: [
      ...createBenzeneRing([1.8, 0, 0], 1.35, 'fpe-ring', [3]).bonds,
      { id: 'ring-o_pe', start: [1.8 - 1.35, 0, 0], end: [-0.7, 0, 0], order: 1 },
      { id: 'o_pe-c_formyl', start: [-0.7, 0, 0], end: [-1.8, 0.5, 0], order: 1 },
      ...createMultiBonds([-1.8, 0.5, 0], [-1.8, 1.75, 0], 2, 'formyl-c=o'),
      { id: 'c_formyl-h', start: [-1.8, 0.5, 0], end: [-2.8, -0.1, 0], order: 1 },
    ],
  },
  ...
  'methyl-salicylate': {
    ...
    atoms: [
      ...createBenzeneRing([0, 0, 0], 1.35, 'ms-ring', [0, 1]).atoms,
      ...
      ...createMethylGroup([4.3, -0.3, 0], [1.2, 0.3, 0], 'ms-me').atoms,
    ],
    bonds: [
      ...createBenzeneRing([0, 0, 0], 1.35, 'ms-ring', [0, 1]).bonds,
      { id: 'ring-c_ester', start: [1.35, 0, 0], end: [2.3, 0.3, 0], order: 1 },
      ...
      { id: 'ring-o_phenol', start: [1.35 * Math.cos(Math.PI / 3), 1.35 * Math.sin(Math.PI / 3), 0], end: [1.2, 1.8, 0], order: 1 },
      { id: 'o_phenol-h', start: [1.2, 1.8, 0], end: [1.9, 2.3, 0], order: 1 },
      ...createMethylGroup([4.3, -0.3, 0], [1.2, 0.3, 0], 'ms-me').bonds,
    ],
  },
  ...
  salicylaldehyde: {
    ...
    atoms: [
      ...createBenzeneRing([0, 0, 0], 1.35, 'sa-ring', [0, 1]).atoms,
    ...
    bonds: [
      ...createBenzeneRing([0, 0, 0], 1.35, 'sa-ring', [0, 1]).bonds,
      { id: 'ring-c_cho', start: [1.35, 0, 0], end: [2.3, 0.3, 0], order: 1 },
      ...createMultiBonds([2.3, 0.3, 0], [2.6, 1.4, 0], 2, 'sa-cho-c=o'),
      { id: 'c_cho-h', start: [2.3, 0.3, 0], end: [3.1, -0.4, 0], order: 1 },
      { id: 'ring-o_oh', start: [1.35 * Math.cos(Math.PI / 3), 1.35 * Math.sin(Math.PI / 3), 0], end: [1.2, 1.8, 0], order: 1 },
