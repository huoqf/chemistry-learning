...
export const FUNCTIONAL_GROUP_3D_MOLECULES: Record<string, Organic3DMolecule> = {
  ...
  'alcohol-oh': {
    ...
    atoms: [
      ...
      { id: 'h11', symbol: 'H', elementName: '氢', position: [-1.25, -1.25, 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h12', symbol: 'H', elementName: '氢', position: [-1.75, 0.15, 0.85], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h13', symbol: 'H', elementName: '氢', position: [-1.75, 0.15, -0.85], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h21', symbol: 'H', elementName: '氢', position: [0.15, 1.45, 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h22', symbol: 'H', elementName: '氢', position: [0.15, 0.2, 1.05], color: ATOM_COLORS.H, radius: 0.2 },
    ],
    bonds: [
      ...
      { id: 'c1-h11', start: [-1.2, -0.2, 0], end: [-1.25, -1.25, 0], order: 1 },
      { id: 'c1-h12', start: [-1.2, -0.2, 0], end: [-1.75, 0.15, 0.85], order: 1 },
      { id: 'c1-h13', start: [-1.2, -0.2, 0], end: [-1.75, 0.15, -0.85], order: 1 },
      { id: 'c2-h21', start: [0.1, 0.4, 0], end: [0.15, 1.45, 0], order: 1 },
      { id: 'c2-h22', start: [0.1, 0.4, 0], end: [0.15, 0.2, 1.05], order: 1 },
    ],
  },
  ...
  'phenol-oh': {
    ...
    atoms: [
      ...createBenzeneRing([0, 0, 0], 1.35, 'phenol-ring').atoms,
      { id: 'oh-o', symbol: 'O', elementName: '酚羟基氧 (共面)', position: [2.5, 0.3, 0], color: ATOM_COLORS.O, radius: 0.32, isFunctionalGroup: true },
      { id: 'oh-h', symbol: 'H', elementName: '酚羟基活泼氢', position: [3.1, -0.3, 0], color: ATOM_COLORS.H, radius: 0.2, isFunctionalGroup: true },
      { id: 'rh1', symbol: 'H', elementName: '氢', position: [1.35 * 1.7 * Math.cos(Math.PI / 3), 1.35 * 1.7 * Math.sin(Math.PI / 3), 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'rh2', symbol: 'H', elementName: '氢', position: [1.35 * 1.7 * Math.cos((2 * Math.PI) / 3), 1.35 * 1.7 * Math.sin((2 * Math.PI) / 3), 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'rh3', symbol: 'H', elementName: '氢', position: [1.35 * 1.7 * Math.cos(Math.PI), 1.35 * 1.7 * Math.sin(Math.PI), 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'rh4', symbol: 'H', elementName: '氢', position: [1.35 * 1.7 * Math.cos((4 * Math.PI) / 3), 1.35 * 1.7 * Math.sin((4 * Math.PI) / 3), 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'rh5', symbol: 'H', elementName: '氢', position: [1.35 * 1.7 * Math.cos((5 * Math.PI) / 3), 1.35 * 1.7 * Math.sin((5 * Math.PI) / 3), 0], color: ATOM_COLORS.H, radius: 0.2 },
    ],
    bonds: [
      ...createBenzeneRing([0, 0, 0], 1.35, 'phenol-ring').bonds,
      { id: 'ring-o', start: [1.35, 0, 0], end: [2.5, 0.3, 0], order: 1 },
      { id: 'o-h', start: [2.5, 0.3, 0], end: [3.1, -0.3, 0], order: 1 },
      { id: 'c1-h', start: [1.35 * Math.cos(Math.PI / 3), 1.35 * Math.sin(Math.PI / 3), 0], end: [1.35 * 1.7 * Math.cos(Math.PI / 3), 1.35 * 1.7 * Math.sin(Math.PI / 3), 0], order: 1 },
      { id: 'c2-h', start: [1.35 * Math.cos((2 * Math.PI) / 3), 1.35 * Math.sin((2 * Math.PI) / 3), 0], end: [1.35 * 1.7 * Math.cos((2 * Math.PI) / 3), 1.35 * 1.7 * Math.sin((2 * Math.PI) / 3), 0], order: 1 },
      { id: 'c3-h', start: [-1.35, 0, 0], end: [-1.35 * 1.7, 0, 0], order: 1 },
      { id: 'c4-h', start: [1.35 * Math.cos((4 * Math.PI) / 3), 1.35 * Math.sin((4 * Math.PI) / 3), 0], end: [1.35 * 1.7 * Math.cos((4 * Math.PI) / 3), 1.35 * 1.7 * Math.sin((4 * Math.PI) / 3), 0], order: 1 },
      { id: 'c5-h', start: [1.35 * Math.cos((5 * Math.PI) / 3), 1.35 * Math.sin((5 * Math.PI) / 3), 0], end: [1.35 * 1.7 * Math.cos((5 * Math.PI) / 3), 1.35 * 1.7 * Math.sin((5 * Math.PI) / 3), 0], order: 1 },
    ],
  },
  ...
  'benzyl-alcohol': {
    ...
    atoms: [
      ...createBenzeneRing([0, 0, 0], 1.3, 'ba-ring').atoms,
      ...
      { id: 'oh-h', symbol: 'H', elementName: '醇羟基氢', position: [3.9, 0.1, -0.5], color: ATOM_COLORS.H, radius: 0.2, isFunctionalGroup: true },
    ],
    bonds: [
      ...createBenzeneRing([0, 0, 0], 1.3, 'ba-ring').bonds,
      { id: 'ring-ch2', start: [1.3, 0, 0], end: [2.3, 0.2, 0.4], order: 1 },
  ...
  'aldehyde-cho': {
    ...
    spatialContrastNote:
      '【易混题眼】：甲酸酯类（如甲酸甲酯 HCOOCH₃）分子式虽是酯，但在 3D 球棍空间中，左端保留了完整的甲酰基醛基氢 (H-C=O)，因此同样具备醛基的所有定性特征（银镜反应出 2 Ag）！',
    variants: [
    ...
    atoms: [
      ...
      { id: 'h1', symbol: 'H', elementName: '氢', position: [-1.2, -1.35, 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h2', symbol: 'H', elementName: '氢', position: [-1.6, 0.1, 0.85], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h3', symbol: 'H', elementName: '氢', position: [-1.6, 0.1, -0.85], color: ATOM_COLORS.H, radius: 0.2 },
    ],
    bonds: [
      ...
      { id: 'c1-h1', start: [-1.1, -0.3, 0], end: [-1.2, -1.35, 0], order: 1 },
      { id: 'c1-h2', start: [-1.1, -0.3, 0], end: [-1.6, 0.1, 0.85], order: 1 },
      { id: 'c1-h3', start: [-1.1, -0.3, 0], end: [-1.6, 0.1, -0.85], order: 1 },
    ],
  },
  ...
  'ketone-co': {
    ...
    atoms: [
      ...
      { id: 'h11', symbol: 'H', elementName: '氢', position: [-1.3, -1.6, 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h12', symbol: 'H', elementName: '氢', position: [-2.0, -0.15, 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h31', symbol: 'H', elementName: '氢', position: [1.3, -1.6, 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h32', symbol: 'H', elementName: '氢', position: [2.0, -0.15, 0], color: ATOM_COLORS.H, radius: 0.2 },
    ],
    bonds: [
      ...
      { id: 'c1-h11', start: [-1.2, -0.55, 0], end: [-1.3, -1.6, 0], order: 1 },
      { id: 'c1-h12', start: [-1.2, -0.55, 0], end: [-2.0, -0.15, 0], order: 1 },
      { id: 'c3-h31', start: [1.2, -0.55, 0], end: [1.3, -1.6, 0], order: 1 },
      { id: 'c3-h32', start: [1.2, -0.55, 0], end: [2.0, -0.15, 0], order: 1 },
    ],
  },
  ...
  'carboxyl-cooh': {
    ...
    atoms: [
      ...
      { id: 'h1', symbol: 'H', elementName: '氢', position: [-1.3, -1.35, 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h2', symbol: 'H', elementName: '氢', position: [-1.7, 0.1, 0.85], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h3', symbol: 'H', elementName: '氢', position: [-1.7, 0.1, -0.85], color: ATOM_COLORS.H, radius: 0.2 },
    ],
    bonds: [
      ...
      { id: 'c1-h1', start: [-1.2, -0.3, 0], end: [-1.3, -1.35, 0], order: 1 },
      { id: 'c1-h2', start: [-1.2, -0.3, 0], end: [-1.7, 0.1, 0.85], order: 1 },
      { id: 'c1-h3', start: [-1.2, -0.3, 0], end: [-1.7, 0.1, -0.85], order: 1 },
    ],
  },
  ...
  'ester-coor': {
    ...
    atoms: [
      { id: 'c1', symbol: 'C', elementName: '甲基碳', position: [-1.9, -0.3, 0], color: ATOM_COLORS.C, radius: 0.35 },
      ...
      { id: 'c3', symbol: 'C', elementName: '亚甲基碳', position: [1.7, 0.3, 0], color: ATOM_COLORS.C, radius: 0.35 },
      { id: 'c4', symbol: 'C', elementName: '末端甲基碳', position: [2.9, -0.45, 0], color: ATOM_COLORS.C, radius: 0.35 },
    ],
    bonds: [
  ...
  'phenol-ester': {
    ...
    atoms: [
      ...createBenzeneRing([1.5, 0, 0], 1.35, 'ester-phenyl').atoms,
      { id: 'o_ester', symbol: 'O', elementName: '酚酯氧 (直连苯环)', position: [-0.1, 0, 0], color: ATOM_COLORS.O, radius: 0.33, isFunctionalGroup: true },
      { id: 'c_ester', symbol: 'C', elementName: '酯羰基碳 (sp²)', position: [-1.2, 0.6, 0], color: ATOM_COLORS.C, radius: 0.35, isFunctionalGroup: true },
      { id: 'o_carbonyl', symbol: 'O', elementName: '羰基氧', position: [-1.15, 1.8, 0], color: ATOM_COLORS.O, radius: 0.33, isFunctionalGroup: true },
      { id: 'c_me', symbol: 'C', elementName: '甲基碳', position: [-2.5, -0.1, 0], color: ATOM_COLORS.C, radius: 0.35 },
    ],
    bonds: [
      ...createBenzeneRing([1.5, 0, 0], 1.35, 'ester-phenyl').bonds,
      { id: 'ring-o_ester', start: [1.5 - 1.35, 0, 0], end: [-0.1, 0, 0], order: 1 },
      { id: 'o_ester-c_ester', start: [-0.1, 0, 0], end: [-1.2, 0.6, 0], order: 1 },
      ...createMultiBonds([-1.2, 0.6, 0], [-1.15, 1.8, 0], 2, 'phenylester-c=o'),
      { id: 'c_ester-c_me', start: [-1.2, 0.6, 0], end: [-2.5, -0.1, 0], order: 1 },
    ],
  },
  ...
  'halo-alkane-x': {
    ...
    atoms: [
      ...
      { id: 'h1', symbol: 'H', elementName: '氢', position: [-1.2, -1.25, 0], color: ATOM_COLORS.H, radius: 0.2 },
      { id: 'h2', symbol: 'H', elementName: '氢', position: [0.25, 1.45, 0], color: ATOM_COLORS.H, radius: 0.2 },
    ],
    bonds: [
      { id: 'c1-c2', start: [-1.1, -0.2, 0], end: [0.2, 0.4, 0], order: 1 },
      { id: 'c2-br', start: [0.2, 0.4, 0], end: [1.6, -0.5, 0], order: 1 },
      { id: 'c1-h1', start: [-1.1, -0.2, 0], end: [-1.2, -1.25, 0], order: 1 },
      { id: 'c2-h2', start: [0.2, 0.4, 0], end: [0.25, 1.45, 0], order: 1 },
    ],
  },
  ...
  'nitro-no2': {
    ...
    atoms: [
      ...createBenzeneRing([0, 0, 0], 1.3, 'nitro-ring').atoms,
    ...
    bonds: [
      ...createBenzeneRing([0, 0, 0], 1.3, 'nitro-ring').bonds,
      { id: 'ring-n_nitro', start: [1.3, 0, 0], end: [2.3, 0, 0], order: 1 },
  ...
  'cyano-cn': {
    ...
    atoms: [
      ...
      { id: 'h1', symbol: 'H', elementName: '甲基氢', position: [-1.8, 1.0, 0], color: ATOM_COLORS.H, radius: 0.22 },
      { id: 'h2', symbol: 'H', elementName: '甲基氢', position: [-1.8, -0.5, 0.86], color: ATOM_COLORS.H, radius: 0.22 },
      { id: 'h3', symbol: 'H', elementName: '甲基氢', position: [-1.8, -0.5, -0.86], color: ATOM_COLORS.H, radius: 0.22 },
    ],
    bonds: [
      { id: 'c_me-c_cyano', start: [-1.4, 0, 0], end: [0.1, 0, 0], order: 1 },
      ...createMultiBonds([0.1, 0, 0], [1.3, 0, 0], 3, 'cyano-c#n'),
      { id: 'c_me-h1', start: [-1.4, 0, 0], end: [-1.8, 1.0, 0], order: 1 },
      { id: 'c_me-h2', start: [-1.4, 0, 0], end: [-1.8, -0.5, 0.86], order: 1 },
      { id: 'c_me-h3', start: [-1.4, 0, 0], end: [-1.8, -0.5, -0.86], order: 1 },
    ],
  },
}
