...
/** 场景坐标系中的点（物理坐标）：单位 m，y 轴向上为正 */
export type PhysicsCoord = Vector2 & { readonly __brand: 'PhysicsCoord' };
/** @deprecated 用 PhysicsCoord */
export type DomainCoord = PhysicsCoord;
...
/** 场景坐标系中的矢量（物理矢量）：单位 m，y 轴向上为正 */
export type PhysicsVector = Vector2 & { readonly __brand: 'PhysicsVector' };
/** @deprecated 用 PhysicsVector */
export type DomainVector = PhysicsVector;
