...
import { CHEMISTRY_COLORS, REFERENCE_MAP, STROKE, DASH, FONT } from '@/theme'
import type { ChartReferenceVariant } from '@/theme'
 ...
 * 对尚未完全迁移到 BaseChart 的 legacy SVG，也可显式传入
...
export function ChartSecant({
  ...
  variant = 'default',
  color,
  triangleColor = CHEMISTRY_COLORS.deltaHighlight,
  showTriangle = true,
  showEndpoints = false,
  dxLabel,
  dyLabel,
