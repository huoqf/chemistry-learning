        ...
        <div className="flex items-start justify-between gap-2">
          <label className="min-w-0 text-xs font-semibold text-neutral-700 leading-6" htmlFor={`param-${param.key}`}>
            <span className="inline-flex items-center gap-1">
              {param.label}
              {param.unit ? <span className="text-neutral-500 font-normal">({param.unit})</span> : null}
            </span>
            {param.description && (
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <input
              ...
              aria-label={typeof param.label === 'string' ? `${param.label}数值` : `${param.key}数值`}
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative flex-1 h-2 bg-neutral-200 rounded-full flex items-center">
            ...
            <input
              ...
              aria-label={typeof param.label === 'string' ? `${param.label}滑块` : `${param.key}滑块`}
            />
            <div
